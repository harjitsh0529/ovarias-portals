                            ...
                            <tr class="donor-row" data-user-id="<?php echo $d_id; ?>">
                                <td>
                                    ...
                                    $detail_data = array(
                                        ...
                                        'donation_type' => get_user_meta($d_id, 'donation_type', true) ?: 'Anonymous Donor',
                                        'travel_available' => get_user_meta($d_id, 'travel_available', true) ?: 'Yes',
                                        'passport_available' => get_user_meta($d_id, 'passport_available', true) ?: 'Yes',
                                        'previous_donations' => get_user_meta($d_id, 'previous_donations', true) ?: 'No',
                                        'phone' => get_user_meta($d_id, 'phone_number', true) ?: '',
                                        'country' => get_user_meta($d_id, 'country', true) ?: '',
                                        'egg_type' => get_user_meta($d_id, 'egg_type', true) ?: 'Fresh',
                                        'num_eggs' => get_user_meta($d_id, 'num_eggs', true) ?: '0',
