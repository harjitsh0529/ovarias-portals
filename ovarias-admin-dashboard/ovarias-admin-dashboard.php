...
define('OVARIAS_ADMIN_VERSION', '1.3.7');
 ...
 */
if (!function_exists('ovarias_admin_register_menu_page')) {
 ...
 */
if (!function_exists('ovarias_admin_render_page_callback')) {
 ...
 */
if (!function_exists('ovarias_admin_dashboard_shortcode')) {
 ...
 */
if (!function_exists('ovarias_general_inquiry_form_shortcode')) {
